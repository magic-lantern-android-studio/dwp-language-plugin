 ...
 * from the specification file <tt>DigitalWorkprint.flex</tt>
 */
class DwpLexer implements FlexLexer {
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return DwpTypes.KEY;
            }
          case 8: break;
          case 2: 
          ...
          case 10: break;
          case 4: 
            { yybegin(YYINITIAL); return DwpTypes.COMMENT;
            }
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return DwpTypes.SEPARATOR;
            }
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return DwpTypes.VALUE;
            }
          case 13: break;
          case 7: 
